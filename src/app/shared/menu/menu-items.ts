...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/admin/content-and-conversion-strategy",
    title: "Content & Conversion Strategy",
    type: "link",
    icontype: "fas fa-calendar-alt text-blue",
  },
  {
    path: "/admin/content-deployement-and-interaction",
    title: "Content Deployment & Interaction",
    type: "link",
