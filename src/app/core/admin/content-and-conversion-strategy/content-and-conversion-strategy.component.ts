...
@Component({
  selector: "app-content-and-conversion-strategy",
  templateUrl: "./content-and-conversion-strategy.component.html",
  styleUrls: ["./content-and-conversion-strategy.component.scss"],
})
export class ContentAndConversionStrategyComponent implements OnInit {
  addModal: BsModalRef;
